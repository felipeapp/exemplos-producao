...
# Retorna uma cópia da string em minúsculo para comparações, tratando símbolos extras em relação a lower()
print(curso.casefold())
...
print("***Engenharia***".strip("*"))
print("***Engenharia***".strip("s"))
print("***Engenharia***".lstrip("*"))
print("***Engenharia***".rstrip("*"))

# Remove prefixo ou sufixo da string
print(curso.removeprefix("Engenharia de "))
print(curso.removesuffix("Produção"))
print("Nome: Felipe Alves".removeprefix("Nome: "))
...
print(curso.replace("de Produção", "é muito legal!"))
